...
if (mafa_db_enabled() && !mafa_db_insert_contact($name, $email, $phone, $service, $message)) {
    mafa_json(500, ['ok' => false, 'error' => 'We could not save your enquiry. Please call 072 145 0792 or email us directly.']);
}
